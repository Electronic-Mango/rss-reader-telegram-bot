    ...
    keyboard = [
        [
            InlineKeyboardButton(
                "Latest message",
                callback_data=SendLatestUpdateData(feed_type, feed_name, data),
            )
        ],
        [
            InlineKeyboardButton(
                "Remove", callback_data=RemoveFeedData(feed_type, feed_name, data)
            )
        ],
        [
            InlineKeyboardButton(
                "« Back to subscriptions", callback_data=NamesData(feed_type, data)
            )
        ],
