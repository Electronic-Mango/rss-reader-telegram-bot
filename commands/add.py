...
def add_conversation_handler():
    return ConversationHandler(
        ...
        states={
            FEED_TYPE: [MessageHandler(TEXT & ~COMMAND, handle_feed_type)],
            FEED_LINK: [MessageHandler(TEXT & ~COMMAND, request_feed_name)],
            FEED_NAME: [MessageHandler(TEXT & ~COMMAND, store_subscription)],
        },
